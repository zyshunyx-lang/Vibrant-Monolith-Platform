...
const translations = {
  en: {
    ...
    'duty.params.prompt.category_name': 'Enter Category Name (e.g., Leader, Male Staff):',
    ...
    'duty.engine.confirm_msg': 'Are you sure you want to publish the roster for {month}? This will overwrite any existing records for this month.',
    'duty.engine.slot_missing_error': "Please configure 'Duty Slots' in Parameter Settings first.",
    // Login & Register
  ...
  zh: {
    ...
    'duty.params.prompt.category_name': '请输入类别名称（如：带班领导、男值班员）：',
    ...
    'duty.engine.confirm_msg': '确定要发布 {month} 的排班表吗？这将覆盖该月份所有现有的记录。',
